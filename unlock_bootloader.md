...
> [!CAUTION]
> 解锁 Bootloader 会导致设备面临各类安全风险，并对设备造成不可预估的影响，可能导致：
> - 设备永久性变砖
> - 硬件损坏
> - 失去官方保修资格
> 
...
## 目录
- [前置要求](#前置要求)
- [启用 ADB调试 功能](#启用-adb调试-功能)
- [连接电脑并授权 ADB](#连接电脑并授权-adb)
- [打开 OEM解锁 选项](#打开-oem-解锁-选项)
...
> **重要提醒：**
>
> 在通常情况下，解除 Bootloader 锁定将清除设备上的所有数据。
>
> 在继续操作前，**请务必备份所有重要数据**。
...
> **重要提醒：**
>
> 在通常情况下，重新锁定 Bootloader 将清除设备上的所有数据。
>
> 在继续操作前，**请务必备份所有重要数据**。
